...
for user in users:
    ...
    try:
        ...
        for file in USER['files']:
            ...
            move(originPath + file['filename'], f"../public/uploads/{id}/requirements/{file['filename']}")
        if USER['type'] == 'Firm':
...
print(f"{COUNT}/{TOTAL} :: {round(SUCCESS/COUNT*100, 2)}% success :: {round(ERRORED/COUNT*100, 2)}% errored")
